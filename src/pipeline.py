...
class ReasoningPipeline:
    ...
    def compose_team(
        ...
        logger.info(
            f"Retrieving context for boss_id={boss_id}, description={boss_description[:50] if boss_description else None}"
        )
        ...
        logger.info(
            f"Built prompt with {len(context['candidate_characters'])} characters, "
